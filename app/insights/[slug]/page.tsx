...
export async function generateMetadata({
  ...
  return {
    ...
    openGraph: {
      ...
      /* Per-article share card. Without this every article inherited the
         site-wide /brand/og.jpg, so seven different pieces posted to LinkedIn
         all looked like the same link. Generated by
         scripts/prepare-insight-og.mjs from the article's own photograph. */
      images: [
        {
          url: `/brand/insights/og/${a.id}.jpg`,
          width: 1200,
          height: 630,
          alt: a.title,
        },
    ...
    twitter: {
      ...
      title: `${a.title} | HariNex Global`,
      description: a.excerpt,
      images: [`/brand/insights/og/${a.id}.jpg`],
    },
  };
}
