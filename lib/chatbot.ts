...
const en: ChatPack = {
  ...
  intents: [
    ...
    },
    {
      ...
      answer:
        'Leadership sits in Taiwan — Chia-Ling Shih as Founder and Chairperson, Morris S.S. Ma as Managing Partner for Taiwan operations, and Dr. D. Ganesh Kumar as Chief Advisor. The global team covers India, South Korea and North America, plus a technical specialist in materials and polymers.',
...
const zh: ChatPack = {
  ...
  intents: [
    ...
    },
    {
      ...
      answer:
        '經營團隊設於台灣——施佳玲擔任創辦人暨董事長、馬士軒擔任台灣營運管理合夥人、甘納緒博士擔任首席顧問。全球團隊涵蓋印度、南韓與北美，另有材料與高分子領域的技術專家。',
