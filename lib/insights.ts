...
const en = {
  ...
  articles: [
    /* ------------------------------------------------------------------ */
    {
      id: 'why-taiwanese-companies-should-explore-india',
      category: 'Market entry',
      title: 'Why Taiwanese companies should explore India',
      excerpt:
        'The commercial logic behind the corridor, and the operational realities that decide whether an entry works.',
      minutes: 6,
      date: '2026-08-05',
      intro:
        'Most Taiwanese manufacturers we speak to have already concluded that India matters. What they have not concluded is what to do about it. The gap between those two positions is where entries succeed or quietly stall, and it is rarely closed by another market report.',
      sections: [
        {
          ...
          p: [
            ...
            'India has the inverse profile — substantial domestic demand, a large and expanding manufacturing base, competitive production economics and deep engineering talent. What it more often lacks is access to the specific process technology that would let a plant move up the value chain.',
            'That is a genuine fit rather than a slogan. A Taiwanese firm with a proven process and no volume outlet, and an Indian firm with volume and no process, are solving each other\'s problem. The difficulty is never the logic. It is the execution.',
          ],
        },
        {
          h: 'What actually blocks entry',
          p: [
            'In our experience the obstacle is almost never opportunity. It is that neither side can efficiently verify the other. A Taiwanese supplier cannot easily tell which of twenty Indian enquiries represents a serious counterparty with the capital and plant to execute. An Indian manufacturer cannot easily tell whether a licensing offer is a mature process or a laboratory result dressed up.',
        ...
        },
        {
          ...
          p: [
            'Licensing is the lowest-commitment route. The Taiwanese party licenses a defined process to an Indian manufacturer, with a technology transfer package, training and a royalty. It preserves capital and tests the market, but it puts the outcome in someone else\'s hands and requires the transfer package to be genuinely complete.',
            ...
            'Supply into India — exporting product or components rather than technology — is the most conservative option and frequently the right first step. It generates real market data, real customer relationships and real distribution learning before any technology leaves the building.',
          ],
        },
        {
    ...
    /* ------------------------------------------------------------------ */
    {
      id: 'taiwan-india-trade-opportunities',
      category: 'Trade',
      title: 'Taiwan–India trade opportunities',
      excerpt:
        'Where the complementary strengths of the two economies create genuine openings.',
      minutes: 5,
      date: '2026-08-05',
      intro:
        'Not every sector where two economies are both active represents an opportunity. The openings worth pursuing are where one side holds capability the other needs and cannot readily build, and where the commercial structure to exploit it is available.',
      sections: [
        {
          h: 'Specialty and performance chemicals',
          p: [
            'Taiwanese formulators hold process knowledge in textile auxiliaries, functional finishes and performance additives. Indian mills and converters face tightening restricted-substance requirements from international brands, which creates demand for compliant chemistry rather than merely cheaper chemistry.',
            'This is one of the clearer opportunities in the corridor: the requirement is externally imposed and dated, which concentrates minds on both sides.',
          ],
        },
        {
          h: 'Pharmaceutical inputs and contract development',
          p: [
            'India has substantial capacity in active ingredients and formulation; Taiwan has strong analytical and development capability alongside a research base. The traffic runs both ways — Indian capacity serving Taiwanese development programmes, and Taiwanese process work supporting Indian manufacturers moving into more complex molecules.',
          ],
        },
        {
          h: 'Electronics and materials for manufacturing scale-up',
          p: [
            'As Indian electronics manufacturing expands, demand grows for the materials, precision components and process equipment that Taiwan\'s supply base has spent decades refining. This is less about finished goods than about the inputs and tooling that make local assembly viable.',
          ],
        },
        {
          h: 'Machinery, automation and cleanroom equipment',
          p: [
            'Taiwanese machine builders occupy a useful position between the cheapest and most expensive options, with the service depth to support a plant through commissioning. For Indian manufacturers upgrading capability rather than buying at the lowest price, this is often the practical fit.',
          ],
        },
        {
          h: 'The barriers that persist',
          p: [
            'Distance and unfamiliarity, which raise the perceived risk of any first transaction. Regulatory divergence, which means a product cleared in one market is not thereby cleared in the other. Payment and contract enforcement concerns, which are usually manageable but rarely discussed early enough.',
            'And language — not conversational English, which is widely available on both sides, but technical and contractual precision, where a mistranslated specification becomes a rejected shipment.',
          ],
        },
        {
  ...
  articles: [
    {
      ...
      category: '市場進入',
      title: '台灣企業為何應該布局印度',
      excerpt: '這條走廊背後的商業邏輯，以及決定市場進入成敗的營運現實。',
      minutes: 6,
      date: '2026-08-05',
      intro:
        '與我們往來的台灣製造業者，多半早已認定印度市場重要；他們尚未決定的，是究竟該怎麼做。這兩者之間的落差，正是市場進入成功或悄然停滯的關鍵，而這道落差極少能靠再多一份市場報告來弭平。',
      sections: [
        {
          h: '互補性是結構性的，而非一時風潮',
          p: [
            '台灣的優勢密集於製程能力：精密製造、材料、半導體與電子供應鏈，以及一支習慣嚴格公差與可供稽核文件的工程人力。台灣不密集的，是內需規模與低成本量產。',
            '印度的條件正好相反——龐大的內需、持續擴張的製造基礎、具競爭力的生產成本，以及深厚的工程人才。印度較常欠缺的，是能讓工廠往價值鏈上游移動的特定製程技術。',
            '這是真實的互補，而非口號。一家擁有成熟製程卻缺乏出海口的台灣企業，與一家握有產量卻缺乏製程的印度企業，正好解決彼此的問題。困難從來不在邏輯，而在執行。',
          ],
        },
        {
          h: '真正卡住市場進入的是什麼',
          p: [
            '依我們的經驗，障礙幾乎從來不是機會不足，而是雙方都無法有效查證對方。台灣供應商難以分辨二十封印度詢價中，哪一封來自真正具備資金與廠房執行能力的對象；印度製造商也難以判斷一項授權提案究竟是成熟製程，還是包裝過的實驗室成果。',
        ...
        },
        {
          h: '三種值得考慮的架構',
          p: [
            '技術授權是承諾最輕的路徑。台方將特定製程授權給印度製造商，並提供技術移轉包、訓練與權利金。它保留資本、也能測試市場，但成敗掌握在他人手中，且要求技術移轉包必須真正完整。',
            '合資能讓雙方誘因更一致，對品質的掌控也更高，但在架構設計、退場與治理上都困難得多。不該僅因為「感覺比授權安全」就預設採用合資——實情往往並非如此。',
            '對印度供貨——輸出產品或零組件而非技術——是最保守的選項，也經常是正確的第一步。它能在任何技術離開公司之前，先取得真實的市場數據、客戶關係與通路經驗。',
          ],
        },
        {
          h: '在承諾之前必須查證的事',
...

    {
      ...
      category: '貿易',
      title: '台印貿易機會',
      excerpt: '兩個經濟體的互補優勢，在哪些地方創造出真正的切入點。',
      minutes: 5,
      date: '2026-08-05',
      intro:
        '並非兩個經濟體都活躍的每個產業都代表機會。真正值得投入的切口，是一方握有另一方需要、且短期內難以自建的能力，同時具備可資運用的商業架構。',
      sections: [
        {
          h: '特用與機能性化學品',
          p: [
            '台灣配方業者在紡織助劑、機能性後整理與性能添加劑上握有製程知識。印度的紡織廠與加工廠正面對國際品牌日益嚴格的限用物質要求，因而產生對「合規化學品」而非僅是「更便宜化學品」的需求。',
            '這是走廊中較明確的機會之一：需求由外部強制、且訂有期限，這使雙方都必須認真面對。',
          ],
        },
        {
          h: '製藥原料與委託開發',
          p: [
            '印度在原料藥與製劑上具備可觀產能，台灣則在分析與開發能力及研究基礎上具優勢。流動是雙向的——印度產能服務台灣的開發專案，台灣的製程開發則支援印度廠商切入更複雜的分子。',
          ],
        },
        {
          h: '支持製造放大的電子與材料',
          p: [
            '隨著印度電子製造擴張，對台灣供應鏈數十年來精進的材料、精密零組件與製程設備需求隨之成長。重點不在成品，而在使在地組裝得以成立的原料與治具。',
          ],
        },
        {
          h: '機械、自動化與無塵室設備',
          p: [
            '台灣機械業者位於「最便宜」與「最昂貴」之間的實用區間，並具備支援工廠走完試車階段的服務深度。對於追求能力升級而非最低價格的印度製造商而言，這通常是務實的選擇。',
          ],
        },
        {
          h: '仍然存在的障礙',
          p: [
            ...
            '還有語言——不是日常英語（雙方都相當普及），而是技術與契約層面的精確度；一份誤譯的規格，會變成一批被退的貨。',
          ],
        },
        {
          h: '用低成本驗證假設',
