    ...
    sections: [
      {
        ...
        p: [
          ...
          'You can reach us at harinex.india@gmail.com for any question about this policy or about data we hold.',
        ],
      },
      {
        h: 'What we collect',
      ...
      },
      {
        ...
        p: [
          ...
          'To exercise any of these, write to harinex.india@gmail.com. We will respond within the period required by applicable law, and will not charge you except where the law permits a fee for producing copies.',
        ],
      },
      {
        h: 'Security',
    ...
    sections: [
      {
        ...
        p: [
          ...
          '如對本政策或我們所持有的資料有任何疑問，可透過 harinex.india@gmail.com 與我們聯繫。',
        ],
      },
      {
        h: '我們蒐集哪些資料',
      ...
      },
      {
        ...
        p: [
          ...
          '欲行使上述任一權利，請來信 harinex.india@gmail.com。我們將於適用法律所定期間內回覆；除法律允許就製給複製本收取必要成本外，不另收費。',
        ],
      },
      {
        h: '資料安全',
